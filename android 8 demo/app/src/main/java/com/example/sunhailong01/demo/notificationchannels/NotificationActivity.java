...
package com.example.sunhailong01.demo.notificationchannels;
...
public class NotificationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ui = new MainUi(findViewById(R.id.notification_main));
    }
    ...
    public void sendNotification(int id, String title) {
        ...
        switch (id) {
            case NOTI_PRIMARY1:
                nb = noti.getNotification1(title, "第一个渠道组通知1");
                break;

            case NOTI_PRIMARY2:
                nb = noti.getNotification1(title, "第一个渠道组通知2");
                break;

            case NOTI_SECONDARY1:
                nb = noti.getNotification2(title, "第二个渠道组通知1");
                break;

            case NOTI_SECONDARY2:
                nb = noti.getNotification2(title, "第二个渠道组通知2");
                break;
        }
        if (nb != null) {
            noti.notify(id, nb);
