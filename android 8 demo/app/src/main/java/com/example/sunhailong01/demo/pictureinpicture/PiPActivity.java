...
package com.example.sunhailong01.demo.pictureinpicture;
...
import com.example.sunhailong01.demo.pictureinpicture.widget.MovieView;
...
public class PiPActivity extends AppCompatActivity {
    ...
    void updatePictureInPictureActions(@DrawableRes int iconId, String title, int controlType,
        ...
        actions.add(new RemoteAction(
                ...
                PendingIntent.getActivity(PiPActivity.this, REQUEST_INFO,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pip_main);
